...
You can load a Wavefront OBJ file setting block `TYPE` to `object` and `MATERIAL` to the OBJ filename. OBJ and MTL must have same filename and must be loaded to media/documents with lowercase extension. 
